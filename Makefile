...
test-integration: test-db
	cd backend && TEST_DATABASE_URL='$(TEST_DATABASE_URL)' go test ./internal/store -run 'TestInventoryLifecycle|TestOverviewAggregates|TestGetKubespinArgoDetails|TestArgoTargetsAndCloudSourcesConfigRoundTrip' -count=1
