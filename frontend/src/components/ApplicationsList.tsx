      ...
      <div className="table-frame">
        {loading ? (
          ...
          <div className="table-state">
            ...
            <span>Clear the filters or onboard a new application.</span>
          </div>
        ) : (
            ...
            <table>
              ...
              <tbody>
                {items.map((item) => {
                  ...
                  return (
                    <tr key={item.id} onClick={() => void navigate(`/applications/${item.id}`)}>
                      <td>
                      ...
                      <td>
                        <span className={`deployment-pill deployment-pill--${item.status}`}>
                          {item.status}
                        </span>
                      </td>
                    </tr>
